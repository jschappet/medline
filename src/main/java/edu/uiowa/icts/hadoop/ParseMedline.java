 ...
 */
public class ParseMedline extends Configured implements Tool
{
    private static final Logger logger = LoggerFactory.getLogger(ParseMedline.class);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        ToolRunner.run(new Configuration(), new ParseMedline(), args);
        System.exit(0);
    }
    ...
    public int run(String[] args) throws Exception
    {
        ...
        for (int i = 0; i < WordCountSetup.TEST_COUNT; i++)
        {
            ...
            job.setJarByClass(ParseMedline.class);
