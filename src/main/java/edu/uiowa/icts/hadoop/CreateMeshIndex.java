...
import edu.uiowa.icts.jobs.AuthorIndex.AuthorMapper;
import edu.uiowa.icts.util.MeshMapper;
import edu.uiowa.icts.util.ParseMapper;

public class CreateMeshIndex extends Configured implements Tool {
	  private static final Logger LOG = Logger.getLogger(CreateMeshIndex.class);
	...
	public static void main(String[] args)  {
	    try {
			ToolRunner.run(new Configuration(), new CreateMeshIndex(), args);
		} catch (Exception e) {
    ...
    public int run(String[] args) throws Exception
    {
       ...
       LOG.info("Starting Job");
		try {
            ...
            job.setJarByClass(CreateMeshIndex.class);
            job.setMapperClass(MeshMapper.class);
