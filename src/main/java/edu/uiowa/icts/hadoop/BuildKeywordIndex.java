 ...
 */
public class BuildKeywordIndex extends Configured implements Tool
{
	
	
    private static final Logger logger = LoggerFactory.getLogger(BuildKeywordIndex.class);
    ...
    static final String OUTPUT_COLUMN_FAMILY = "PubsByKeyword";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        ToolRunner.run(new Configuration(), new BuildKeywordIndex(), args);
        System.exit(0);
    }
...
//	            
				...
				List<String> combinations = c.getCombinations(terms,3);
...
//	            }				
    ...
    public static class ReducerToCassandra extends Reducer<Text, IntWritable, ByteBuffer, List<Mutation>>
    {
        ...
        throws IOException, InterruptedException
        {
            outputKey = ByteBufferUtil.bytes("word_count_20120424_0800");
        }
    ...
    public int run(String[] args) throws Exception
    {
		...
		try {
            ...
            job.setJarByClass(BuildKeywordIndex.class);
...
//
	        ...
	        ConfigHelper.setInitialAddress(job.getConfiguration(), "emrb-compute01.icts.uiowa.edu");
