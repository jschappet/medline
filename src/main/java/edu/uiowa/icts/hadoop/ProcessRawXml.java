...
public class ProcessRawXml extends Configured implements Tool {
	  private static final Logger LOG = Logger.getLogger(ProcessRawXml.class);
	...
	public static void main(String[] args)  {
	    try {
			ToolRunner.run(new Configuration(), new ProcessRawXml(), args);
		} catch (Exception e) {
	 ...
	 static private void printUsage() {
	    	System.out.println("\n");
	    	System.out.println("Process Raw Xml\n");
    ...
    public int run(String[] args) throws Exception
    {
       ...
       LOG.info("Starting Job");
		try {
            ...
            job.setJarByClass(ProcessRawXml.class);
